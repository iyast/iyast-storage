	...
	return iatExtension({
		...
		category1:	{
			...
			attribute2 :
			{
				...
				stimulusMedia : [ //Stimuli content as PIP's media objects
					{word: 'בגיל 11 נסעתי לגרמניה'},
					{word: 'עשינו טיול קרוואנים בגרמניה'},
					{word: 'מוזיאונים היו בחינם בזכות הנסיך'},
					{word: 'הקרוואן שלנו נכנס במרפסת'},
					{word: 'צחקנו על אבא בתקרית עם השכן'}
				],
				//Stimulus css
				stimulusCss : {color:'#0000FF','font-size':'2.1em'}
			},	
