	...
	return iatExtension({
		...
		category1:	{
			...
			attribute2 :
			{
				name : 'טיול לאורלנדו',
				title : {
					media : {word : 'טיול לאורלנדו'},
					css : {color:'#0000FF','font-size':'2em'},
					height : 4 //Used to position the "Or" in the combined block.
				},
				stimulusMedia : [ //Stimuli content as PIP's media objects
					{word: 'עליתי על רכבת של הלהקה ארוסמית'},
					{word: 'אכלתי גלידת וניל שהייתה גדולה'},
					{word: 'הגלידה נפלה והביאו לי חדש'},
					{word: 'עליתי על רכבת שנופלת לתוך מים'},
					{word: 'הרכבת הראשונה הייתה מלחיצה'}
				],
				//Stimulus css
				stimulusCss : {color:'#0000FF','font-size':'2.1em'}
			},	
