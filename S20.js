	...
	return iatExtension({
		...
		category1:	{
			...
			attribute2 :
			{
				name : 'טיול לטנזניה',
				title : {
					media : {word : 'טיול לטנזניה'},
					css : {color:'#0000FF','font-size':'2em'},
					height : 4 //Used to position the "Or" in the combined block.
				},
				stimulusMedia : [ //Stimuli content as PIP's media objects
					{word: 'ראיתי אריה שטורף איילה'},
					{word: 'דיברתי עם סבתא על דודה'},
					{word: 'אכלתי בננה אדומה'},
					{word: 'הדלקתי מנורה על ידי משיכת חבל'},
					{word: 'צילמתי שילוט מעץ'}
				],
				//Stimulus css
				stimulusCss : {color:'#0000FF','font-size':'2.1em'}
			},	
