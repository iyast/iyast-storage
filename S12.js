	...
	return iatExtension({
		...
		category1:	{
			...
			attribute1 :
			{
				name : 'טיול לעמאן',
				title : {
					media : {word : 'טיול לעמאן'},
					css : {color:'#0000FF','font-size':'2em'},
					height : 4 //Used to position the "Or" in the combined block.
				},
				stimulusMedia : [ //Stimuli content as PIP's media objects
					{word: 'ביקרתי בגן שעשועים בעמאן'},
					{word: 'ישבתי בתוך כוס תה מסתובב'},
					{word: 'זוכרת ריח של ממתקים וחטיפים'},
					{word: 'הרגשתי ברת מזל ואהובה'},
					{word: 'אמא צילמה אותי במתקן הכוסות'}
				],
				//Stimulus css
