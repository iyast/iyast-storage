	...
	return iatExtension({
		...
		category1:	{
			...
			attribute2 :
			{
				...
				stimulusMedia : [ //Stimuli content as PIP's media objects
					{word: 'בגיל 10 ביקרתי בנחל הבניאס'},
					{word: 'התחלתנו את הטיול מוקדם בבוקר'},
					{word: 'חצינו גשר ומתחתינו עברו מים'},
					{word: 'בסוף המסלול ראיתי את המפל'},
					{word: 'לאחר המסלול הקמנו אוהלים'}
				],
				//Stimulus css
				stimulusCss : {color:'#0000FF','font-size':'2.1em'}
			},	
