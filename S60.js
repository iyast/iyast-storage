	...
	return iatExtension({
		...
		category1:	{
			...
			attribute2 :
			{
				...
				stimulusMedia : [ //Stimuli content as PIP's media objects
					{word: 'בגיל 10 טיילתי בנחל בירושלים'},
					{word: 'בדרך לנחל היו פיתולים מסוכנים'},
					{word: 'נכנסתי לבריכה מלאה באנשים'},
					{word: 'הנחל נראה לי יפה כשהגעתי'},
					{word: 'ביקרתי בנחל עם אבא וחברו'}
				],
				//Stimulus css
				stimulusCss : {color:'#0000FF','font-size':'2.1em'}
			},	
