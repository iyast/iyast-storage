	...
	return iatExtension({
		...
		category1:	{
			...
			attribute2 :
			{
				...
				stimulusMedia : [ //Stimuli content as PIP's media objects
					{word: 'ביקרתי בדיסני וורלד באורלנדו'},
					{word: 'ישנו במלון מעוצב בדמויות דיסני'},
					{word: 'אכלתי ופל בצורה של מיקי'},
					{word: 'עליתי על מתקנים מגניבים'},
					{word: 'ראיתי מזרקה עליה הוקרן סרט'}
				],
				//Stimulus css
				stimulusCss : {color:'#0000FF','font-size':'2.1em'}
			},	
