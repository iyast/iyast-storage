	...
	return iatExtension({
		...
		category1:	{
			...
			attribute1 :
			{
				...
				stimulusMedia : [ //Stimuli content as PIP's media objects
					{word: 'טיילתי בהרים בשוויץ עם חברה'},
					{word: 'מזג האוויר בהרים היה קריר'},
					{word: 'התלהבתי מהנוף הירוק'},
					{word: 'זוכרת את מגע הרוח הקרירה'},
					{word: 'נסעתי לבד לשוויץ'}
				],
				//Stimulus css
			...
			attribute2 :
			{
				...
				stimulusMedia : [ //Stimuli content as PIP's media objects
					{word: 'היה מלחיץ לעלות במעלית'},
					{word: 'ראיתי ילד בגילי עם כובע צהוב'},
					{word: 'אכלתי גלידת שוקולד במגדל'},
					{word: 'התרגשתי מהנוף של העיר'},
					{word: 'אנשים נראו כמו נמלים'}
				],
				//Stimulus css
				stimulusCss : {color:'#0000FF','font-size':'2.1em'}
			},	
