	...
	return iatExtension({
		...
		category1:	{
			...
			attribute2 :
			{
				name : 'טיול למרכז',
				title : {
					media : {word : 'טיול למרכז'},
					css : {color:'#0000FF','font-size':'2em'},
					height : 4 //Used to position the "Or" in the combined block.
				},
				stimulusMedia : [ //Stimuli content as PIP's media objects
					{word: 'בגיל 8 נסענו לחגוג ביער'},
					{word: 'ביום עצמאות עשינו פיתות בטאבון'},
					{word: 'ההורים עשו זולה כיפית'},
					{word: 'בתור משחק הרכבנו המנון'},
					{word: 'הצגנו המנון ודגל להורים'}
				],
				//Stimulus css
				stimulusCss : {color:'#0000FF','font-size':'2.1em'}
			},	
