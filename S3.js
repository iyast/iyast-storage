define(['pipAPI', 'https://tmo286.github.io/scripts-for-Qualtrics/fullaiateng.js'], function(APIConstructor, iatExtension){
	...
	return iatExtension({
		...
		category1:	{
			...
			stimulusMedia : [ //Stimuli content as PIP's media objects
    		    {word : 'אני מטפסת על הר'}, 
    			{word : 'אני בחוף הים'}, 
    			{word : 'אני אוכלת במסעדה במרכז העיר'}, 
    			{word : 'אני משחקת עכשיו כדורגל'}, 
    			{word : 'אני נמצאת עכשיו בחנות'}			
				], 
			//Stimulus css
			stimulusCss : {color:'#31940F','font-size':'2.1em'}
		},
			...
			attribute2 :
			{
				name : 'טיול לאתיופיה',
				title : {
					media : {word : 'טיול לאתיופיה'},
					css : {color:'#0000FF','font-size':'2em'},
					height : 4 //Used to position the "Or" in the combined block.
				},
				stimulusMedia : [ //Stimuli content as PIP's media objects
					{word: 'טסתי לראשונה בילדותי לאתיופיה'},
					{word: 'היינו בבית מלון עם צורה של פירמידות'},
					{word: 'עלינו על סירה באגם עם מדריך'},
					{word: 'ראיתי היפופוטם עם ציפור מעליו'},
					{word: 'הרגשתי בגן עדן בעודי בסירה'}
				],
				//Stimulus css
				stimulusCss : {color:'#0000FF','font-size':'2.1em'}
			},	
