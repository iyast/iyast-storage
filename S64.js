	...
	return iatExtension({
		...
		category1:	{
			...
			attribute2 :
			{
				...
				stimulusMedia : [ //Stimuli content as PIP's media objects
					{word: 'בגיל 12 נסעתי לתאילנד'},
					{word: 'ערב אחד נשארנו בדירה והזמנו פיצה'},
					{word: 'ישבתי עם אחי על שפת הנהר'},
					{word: 'התענגנו על טעם הפיצה בתאילנד'},
					{word: 'ערב אחד צחקנו מלא בתאילנד'}
				],
				//Stimulus css
				stimulusCss : {color:'#0000FF','font-size':'2.1em'}
			},	
