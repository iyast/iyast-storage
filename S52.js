	...
	return iatExtension({
		...
		category1:	{
			...
			attribute2 :
			{
				name : 'טיול לארהב',
				title : {
					media : {word : 'טיול לארהב'},
					css : {color:'#0000FF','font-size':'2em'},
					height : 4 //Used to position the "Or" in the combined block.
				},
				stimulusMedia : [ //Stimuli content as PIP's media objects
					{word: 'בגיל 6 נסעתי לארצות הברית'},
					{word: 'ביקרנו במפעל ליצור דובי'},
					{word: 'הלבשתי את הדובי בבגדים לטעמי'},
					{word: 'המדריכה נתנה לי פתק בצורת לב'},
					{word: 'המדריכה עשתה פרצוף עצוב'}
				],
				//Stimulus css
				stimulusCss : {color:'#0000FF','font-size':'2.1em'}
			},	
