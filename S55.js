	...
	return iatExtension({
		...
		category1:	{
			...
			attribute2 :
			{
				name : 'טיול לחיפה',
				title : {
					media : {word : 'טיול לחיפה'},
					css : {color:'#0000FF','font-size':'2em'},
					height : 4 //Used to position the "Or" in the combined block.
				},
				stimulusMedia : [ //Stimuli content as PIP's media objects
					{word: 'ראיתי פרחים בצבעים מגוונים'},
					{word: 'ביקרתי בתור ילדה בגני הבהאיים'},
					{word: 'עלינו על הרבה מדרגות'},
					{word: 'התרשמתי מהסדר והאסתטיקה'},
					{word: 'למדנו על הקהילה בביקור'}
				],
				//Stimulus css
				stimulusCss : {color:'#0000FF','font-size':'2.1em'}
			},	
