define(['pipAPI', 'https://tmo286.github.io/scripts-for-Qualtrics/fullaiateng.js'], function(APIConstructor, iatExtension){
	...
	return iatExtension({
		...
		category1:	{
			...
			attribute1 :
			{
				name : 'טיול לקליפורניה',
				title : {
					media : {word : 'טיול לקליפורניה'},
					css : {color:'#0000FF','font-size':'2em'},
					height : 4 //Used to position the "Or" in the combined block.
				},
				stimulusMedia : [ //Stimuli content as PIP's media objects
					{word: 'ביקרתי בדיסנילנד בקליפורניה'},
					{word: 'אכלתי קורנדוג לראשונה'},
					{word: 'אהבתי את הטעם של הקורנדוג'},
					{word: 'היו מלא חנויות בסגנון דיסני'},
					{word: 'היו אנשים בכל הגילאים מסביבי'}
				],
				//Stimulus css
