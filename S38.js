	...
	return iatExtension({
		...
		category1:	{
			...
			attribute2 :
			{
				name : 'טיול לסופיה',
				title : {
					media : {word : 'טיול לסופיה'},
					css : {color:'#0000FF','font-size':'2em'},
					height : 4 //Used to position the "Or" in the combined block.
				},
				stimulusMedia : [ //Stimuli content as PIP's media objects
					{word: 'הכניסה לפארק נראתה מושקעת'},
					{word: 'ראיתי דוכנים של מאפים'},
					{word: 'ראיתי פסל של איש עם כנפיים'},
					{word: 'ראיתי פסלים יחסית גדולים'},
					{word: 'ביקרתי בפארק בסופיה'}
				],
				//Stimulus css
				stimulusCss : {color:'#0000FF','font-size':'2.1em'}
			},	
