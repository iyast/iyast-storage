	...
	return iatExtension({
		...
		category1:	{
			...
			attribute2 :
			{
				name : 'טיול לשדה בוקר',
				title : {
					media : {word : 'טיול לשדה בוקר'},
					css : {color:'#0000FF','font-size':'2em'},
					height : 4 //Used to position the "Or" in the combined block.
				},
				stimulusMedia : [ //Stimuli content as PIP's media objects
					{word: 'התחלנו את היום בקבר בן גוריון'},
					{word: 'הצטלמתי עם כאפיה'},
					{word: 'העברנו הדרכה על נבאטים'},
					{word: 'בערב ישנו בחאן שיירות'},
					{word: 'אכלתי מלוואח בערב'}
				],
				//Stimulus css
				stimulusCss : {color:'#0000FF','font-size':'2.1em'}
			},	
