	...
	return iatExtension({
		...
		category1:	{
			...
			attribute1 :
			{
				name : 'טיול לאולחון',
				title : {
					media : {word : 'טיול לאולחון'},
					css : {color:'#0000FF','font-size':'2em'},
					height : 4 //Used to position the "Or" in the combined block.
				},
				stimulusMedia : [ //Stimuli content as PIP's media objects
					{word: 'ישבתי עם המשפחה על החוף'},
					{word: 'לקחנו אבנים והלכנו בכיוון ההר  '},
					{word: 'עלינו מהר להר'},
					{word: 'היה ריח של גשם בדרך להר'},
					{word: 'הסתכלתי לכיוון האופק וראיתי עננים'}
				],
				//Stimulus css
