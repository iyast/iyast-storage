define(['pipAPI', 'https://tmo286.github.io/scripts-for-Qualtrics/fullaiateng.js'], function(APIConstructor, iatExtension){
	...
	return iatExtension({
		category2 : {
			name : 'Trueאמת', //Will appear in the data.
			title : {
				media : {word : 'Trueאמת'}, //Name of the category presented in the task.
		...
		category1:	{
			name : 'Falseשקר', //Will appear in the data.
			title : {
				media : {word : 'Falseשקר'}, //Name of the category presented in the task.
				css : {color:'#31940F','font-size':'2em'}, //Style of the category title.
				height : 4 //Used to position the "Or" in the combined block.
			}, 
			stimulusMedia : [ //Stimuli content as PIP's media objects
			...
			attribute1 :
			{
				name : 'Thailandטיול לתאילנד',
				title : {
					media : {word : 'Thailandטיול לתאילנד'},
					css : {color:'#0000FF','font-size':'2em'},
					height : 4 //Used to position the "Or" in the combined block.
				},
				stimulusMedia : [ //Stimuli content as PIP's media objects
					{word: 'ביקרתי בקניון בבנגקוק'},
					{word: 'התלהבתי מתאי השירותים'},
					{word: 'אכלתי גלידה קצת מאכזבת'},
					{word: 'נהניתי לעבור בין קומות שונות'},
					{word: 'טסתי עם המשפחה לתאילנד'}
				],
				//Stimulus css
			...
			attribute2 :
			{
				name : 'Parisטיול לפריז',
				title : {
					media : {word : 'Parisטיול לפריז'},
					css : {color:'#0000FF','font-size':'2em'},
					height : 4 //Used to position the "Or" in the combined block.
				},
				stimulusMedia : [ //Stimuli content as PIP's media objects
