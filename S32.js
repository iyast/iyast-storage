	...
	return iatExtension({
		...
		category1:	{
			...
			attribute2 :
			{
				name : 'טיול לברצלונה',
				title : {
					media : {word : 'טיול לברצלונה'},
					css : {color:'#0000FF','font-size':'2em'},
					height : 4 //Used to position the "Or" in the combined block.
				},
				stimulusMedia : [ //Stimuli content as PIP's media objects
					{word: 'ראיתי אורות בצבעי שחור ואדום'},
					{word: 'הרגשתי רגשות מגוונים במתקן'},
					{word: 'בזמן ההמתנה היו הרבה רחשים'},
					{word: 'היה תור ארוך למתקן האימה'},
					{word: 'ביקרתי בפארק שעשועים טיבידאבו'}
				],
				//Stimulus css
				stimulusCss : {color:'#0000FF','font-size':'2.1em'}
			},	
