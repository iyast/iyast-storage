	...
	return iatExtension({
		...
		category1:	{
			...
			attribute1 :
			{
				name : 'טיול לאמסטרדם',
				title : {
					media : {word : 'טיול לאמסטרדם'},
					css : {color:'#0000FF','font-size':'2em'},
					height : 4 //Used to position the "Or" in the combined block.
				},
				stimulusMedia : [ //Stimuli content as PIP's media objects
					{word: 'עשינו שייט בסירה מקורה'},
					{word: 'אכלתי גלידה ברחובות העיר'},
					{word: 'הרחתי טיגון מדוכני הצ'יפס'},
			...
			attribute2 :
			{
				...
				stimulusMedia : [ //Stimuli content as PIP's media objects
					{word: 'הרתגשתי מהחנות של מארוויל'},
					{word: 'אכלתי קריפ עם שוקולד'},
					{word: 'פחדתי בתור לרכבת הרים'},
					{word: 'קניתי אוזניות של מיקי מאווס'},
					{word: 'ראיתי שדרה ענקית בכניסה'}
				],
				//Stimulus css
				stimulusCss : {color:'#0000FF','font-size':'2.1em'}
			},	
