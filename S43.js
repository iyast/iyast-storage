define(['pipAPI', 'https://tmo286.github.io/scripts-for-Qualtrics/fullaiateng.js'], function(APIConstructor, iatExtension){
	...
	return iatExtension({
		...
		category1:	{
			...
			attribute2 :
			{
				name : 'טיול לארצות הברית',
				title : {
					media : {word : 'טיול לארצות הברית'},
					css : {color:'#0000FF','font-size':'2em'},
					height : 4 //Used to position the "Or" in the combined block.
				},
				stimulusMedia : [ //Stimuli content as PIP's media objects
					{word: 'סיימנו את המסלול רעבים'},
					{word: 'התרגשתי מהנוף בשמורת הטבע'},
					{word: 'ביקרנו במסעדה והיה לי טעים'},
					{word: 'בגיל 11 נסעתי לארצות הברית'},
					{word: 'ביקרתי עם המשפחה ביוסמטי'}
				],
				//Stimulus css
				stimulusCss : {color:'#0000FF','font-size':'2.1em'}
			},	
